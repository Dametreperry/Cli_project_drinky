class CLI
    ...
    def greeting 
        ...
        puts "*^" * 45
        puts ""
        puts "Welcome to the Drinky CLI App"
        puts ""
        puts "The CLI app to get info about your favorite cocktails!"
        puts ""
        puts "*^" *45
        puts "Shaking..."
        puts "Shaking..."
    ...
    def menu
        ...
        if user_input == 1
            ...
            puts "Sorry, unrecognzie entry. Please try again:"
            menu
        end
    end
    ...
    def what_next
        ...
        if user_input == 1
            ...
            "Sorry, unrecognzie entry. Please try again:"
            what_next
        end
    end 
    ...
    def goodbye
        ...
        def print_all_cocktails
            ...
            def print_single_shaken_cocktail(single_shaken_cocktail)
                puts ""
                puts "^" * 50
                puts "#{single_shaken_cocktail.name}" 
                puts ""
